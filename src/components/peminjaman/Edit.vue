...
export default {
    ...
    created() {
        ...
        axios.get(`http://localhost:8000/api/peminjaman/${this.$route.params.id}`,{ headers : { 'Authorization' : `Bearer ` + this.$store.state.token} })
                  .then(res => {
    ...
    methods : {
         edit() {
            axios.put(`http://localhost:8000/api/update/${this.$route.params.id}`, this.pinjam,{ headers : { 'Authorization' : `Bearer ` + this.$store.state.token} })
